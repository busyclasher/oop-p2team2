...
public enum EntityType {
    ...
    // ── Bad entities (faster — harder to avoid) ─────────────────────
    ...
    // ── Frenzy-only bad entities (fastest) ──────────────────────────
    ...
    /** Per-type display size in pixels (square). Returns 0 for PLAYER. */
